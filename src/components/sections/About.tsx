        ...
        <div className="wrap about-grid">
          <RevealOnScroll>
            ...
            <h2 className="about-h">
              {t(
                <>Wir sind Hugo,<br />Nanny & <em>Tilmann.</em></>,
                <>We are Hugo,<br />Nanny & <em>Tilmann.</em></>
              )}
            </h2>
            {t(
              <>
                <p className="about-p">Wir sind kein Studio. Wir sind drei Menschen, die sich unsterblich in Hochzeiten verliebt haben — nicht wegen des Glamours, sondern wegen der Ehrlichkeit. Weil an keinem anderen Tag so viel auf einmal passiert.</p>
              ...
              <>
                <p className="about-p">We're not a studio. We're three people who fell deeply in love with weddings — not for the glamour, but for the honesty. Because no other day holds this much at once.</p>
            ...
            <p className="about-sig">Hugo, Nanny & Tilmann</p>
          </RevealOnScroll>
          <RevealOnScroll className="rv2">
            <div className="about-img">Team-Foto</div>
          </RevealOnScroll>
        </div>
      </section>
    </>
