...
const InquiryForm = () => {
  ...
  return (
    <>
      <hr className="rule" />
      <section id="inquiry">
        <div className="wrap inquiry-inner">
          <RevealOnScroll>
            <span className="label">{t("Anfrage", "Inquiry")}</span>
            <h2 className="contact-h">
              {t(
                <>Erzählt uns von<br /><em>euch.</em></>,
                <>Tell us about<br /><em>yourselves.</em></>
              )}
            </h2>
          </RevealOnScroll>
              ...
              <div className="cf-row">
                <div className="cf">
                  ...
                  <input
                    type="text"
                    name="names"
                    placeholder={t("Anna & Max", "Anna & Max")}
                    required
                  />
                </div>
                <div className="cf">
              ...
              <div className="cf-row">
                ...
                <div className="cf">
                  ...
                  <input
                    type="text"
                    name="venue"
                    placeholder={t("Toskana, Italien", "Tuscany, Italy")}
                    required
                  />
                </div>
              </div>
